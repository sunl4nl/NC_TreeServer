...
//            return clone;
        ...
        {
            var componentList  = SceneManager.GetActiveScene().GetComponentList(typeof(T));
            if (componentList != null)
            {
                return componentList.components as T[];
            }
            return default(T[]);
        ...
        {
            var componentList = SceneManager.GetActiveScene().GetComponentList(type);
            if (componentList == null)
                return null;
