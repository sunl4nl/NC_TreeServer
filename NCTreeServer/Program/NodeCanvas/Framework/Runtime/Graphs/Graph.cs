...
namespace NodeCanvas.Framework{
	...
	abstract public partial class Graph : ScriptableObject, ITaskSystem, ISerializationCallbackReceiver, IScriptableComponent {
		...
		public string Serialize(bool pretyJson, List<Object> objectReferences){
		...
		public GraphSerializationData Deserialize(string serializedGraph, bool validate, List<Object> objectReferences){
		...
		public void GetSerializationData(out string json, out List<Object> references){
			...
			references = _objectReferences != null? new List<Object>(_objectReferences) : null;
		}

		///Sets the target list of UnityObject references. This is for internal use and highly not recomended to do.
		public void SetSerializationObjectReferences(List<Object> references){
...
#else
                Console.WriteLine("<b>Graph:</b> Graph is already Active.");
#endif
                return;
			}
...
#else
                Console.WriteLine("<b>Graph:</b> You've tried to start a graph with null Agent.");
#endif
                return;
			}
...
#else 
                Console.WriteLine("<b>Graph:</b> You've tried to start graph without 'Start' node");
#endif
                return;
			}
...
#else 
                    Console.WriteLine("<b>Graph:</b> Graph started without blackboard. Looking for blackboard on agent '" + agent.gameObject + "'...", agent.gameObject);
#endif
...
#else 
                        Console.WriteLine("<b>Graph:</b> Blackboard found");
#endif
                    }
				}
				if (blackboard == null){
...
#else
                    Console.WriteLine("<b>Graph:</b> Started with null Blackboard. Using Local instead...");
#endif
