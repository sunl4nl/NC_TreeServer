...
#if ABSTRACT_UNITY || UNITY_EDITOR //handles missing variable types
		...
		public override void InitializePropertyBinding(GameObject go, bool callSetter = false){
		    ...
		    if (prop != null){
			    ...
			    if (prop.CanRead){
			    	...
			    	getter = ()=> {
#if !ABSTRACT_UNITY
                        Debug.LogError(string.Format("You tried to Get a Property Bound Variable '{0}', but the Bound Property '{1}' is Write Only!", name, _propertyPath) );
#endif
                        return default(T);
                    };
			    }
			    ...
			    if (prop.CanWrite){
			    	...
			    	setter = (o)=> {
#if !ABSTRACT_UNITY
                        Debug.LogError(string.Format("You tried to Set a Property Bound Variable '{0}', but the Bound Property '{1}' is Read Only!", name, _propertyPath) );
#endif
                    };
			    }
