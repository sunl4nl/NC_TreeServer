...
#if ABSTRACT_UNITY
using LogType = AbsUnity.LogType;
#else 
...
namespace ParadoxNotion
{
	...
	public static class ReflectionTools {
		...
		static void LateLog(object logMessage, LogType logType = LogType.Log){
			#if UNITY_EDITOR
        ...
        static Type TryResolveGenericType(string typeFullName, bool fallbackNoNamespace = false, Type fallbackAssignable = null){
            ...
            {
                LateLog("<b>(Type Request)</b> BUG (Please report this): " + e.Message, LogType.Error);
                return null;
            }
        }
...
#if ABSTRACT_UNITY
            if (!trueSignature && t == typeof(AbsUnity.Object))
            {
                return "AbsUnityObject";
            }
#else
